 ...
 */
public class IndentInfoFragment extends BaseFrag {
    ...
    private final static String ITEM_INDENT = "ITEM_INDENT";
    ...
    public void load(JSONObject jsonObject) {
        ...
        String output_time = jsonObject.getJSONObject("data").getString("output_time");
        ...
        mapiItemResult.setOutput_time(output_time);
        if(null!=result){
            mList.add(new IndexData(0, SCROLL,result));
        }else{
            mList.add(new IndexData(0, SCROLL, new ArrayList<MapiResourceResult>()));
        }
        mList.add(new IndexData(1, TOOL_INDENT, mapiItemResult));
        if(null!=result){
            mList.add(new IndexData(2, ITEM_INDENT, similar));
        }else{
            mList.add(new IndexData(2, ITEM_INDENT, new ArrayList<MapiResourceResult>()));
        }
