 ...
 */
public class OrderIndentFailFragment extends BaseFrag {
    ...
    public OrderIndentFailFragment() {
...
//        recyclerView.addItemDecoration(new DividerListItemDecoration(getActivity(), OrientationHelper.HORIZONTAL, DPUtil.dip2px(8), Color.parseColor("#f7f7f7")));
    ...
    public void load(){
        ...
        showLoading();
        ItemApi.orderList(getActivity(), pageIndex + "", "3", new RequestPageCallback<List<MapiOrderResult>>() {
            @Override
