 ...
 */
public class HomeStarLayout extends RelativeLayout {
    ...
    public HomeStarLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView() {
        if (isInEditMode())
            return;
        view = LayoutInflater.from(mContext).inflate(R.layout.layout_home_star, this);
