package com.yigu.house.fragment.vip;
 ...
 */
public class VipInfoFragment extends BaseFrag {
    ...
    private final static String ITEM_VIP = "ITEM_VIP";
    ...
    public void load(JSONObject jsonObject) {
       ...
       result = JSONArray.parseArray(jsonObject.getJSONObject("data").getJSONArray("img").toJSONString(),MapiResourceResult.class);
        ...
        if(null!=result){
            mList.add(new IndexData(2, ITEM_VIP, similar));
        }else{
            mList.add(new IndexData(2, ITEM_VIP, new ArrayList<MapiResourceResult>()));
        }
