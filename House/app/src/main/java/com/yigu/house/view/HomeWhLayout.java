 ...
 */
public class HomeWhLayout extends RelativeLayout {
    ...
    public HomeWhLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        initView();
    }

    public HomeWhLayout(Context context, AttributeSet attrs, int defStyleAttr) {
