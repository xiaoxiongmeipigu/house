...
public class PromptDetailActivity extends BaseActivity {
    ...
    private PromptInfoFragment topFragment;
    ...
    private void initView() {
        ...
        topFragment = new PromptInfoFragment();
        bottomFragment = new PromptDetailFragment();

        topFragment.setSizeOpenListener(new PromptInfoFragment.SizeOpenListener() {
            @Override
            public void open() {
                album();
            }
